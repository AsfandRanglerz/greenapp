    ...
    <div class="mb-5 admin-main-content-inner">
        ...
        <div>
            <ul class="nav nav-bar horizontal_tabs nav-pills mb-3" id="header-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="pills-cancelation-tab" data-toggle="pill" href="#pills-cancelation"
                        role="tab" aria-controls="pills-Cancelation" aria-selected="false">Cancelation</a>
                </li>
            </ul>
        </div>
                        ...
                        <div class="tab-content" id="v-visa-tabContent">
                            ...
                            @if ($new_visa_data)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->job_offer_file_name }}</label>
                                                        @php
                                ...
                                <div class="tab-pane fade" id="v-pills-visa2_1" role="tabpanel"
                                    ...
                                    <div class='rounded p-3 light-box-shadow'>
                                        <form action="{{ route('company.new-visa-updation-company', $new_visa_data->id) }}"
                                            class='py-2' method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="text" value='waiting_for_approval'
                                                name='waiting_for_approval' hidden>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 d-none new-visa-signmbstatus-comment">
                                                    ...
                                                    <textarea type="text" id='sponsor2-textarear-13' name="comment" placeholder="Enter Your Comments ..."
                                                        class="form-control" rows="5">{{ $new_visa_data->waiting_fappro_reason }}</textarea>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $new_visa_data->waiting_fappro_no }}">
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='visa2-file-bio_1' name="waiting_fappro_reason_file"
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="visa3-transaction-number" placeholder="..." disabled
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="visa3-transaction-fee" placeholder="..." disabled
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->dubai_insurance_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $new_visa_data->pre_approved_wp_tran_no }}"
                                                            name="">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="preapproval-transaction-fee" placeholder="..." disabled
                                                            value="{{ $new_visa_data->pre_approved_wp_tran_fees }}"
                                                            name="">
                                                    </div>
                                                </div>
                                                <div class="form-group col-xl-6 col-lg-12 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="preapproval-transaction-date" placeholder="..." disabled
                                                            value="{{ $new_visa_data->pre_approved_wp_date }}"
                                                            name="">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->pre_approved_wp_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row align-items-end fine-select-container">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="entry-visa-number"
                                                            placeholder="..." disabled
                                                            value={{ $new_visa_data->enter_visa_ts_no }}>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="entry-visa-fee"
                                                            placeholder="..." disabled
                                                            value={{ $new_visa_data->enter_visa_ts_fee }}>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="entry-transaction-date" placeholder="..." disabled
                                                            value={{ $new_visa_data->enter_visa_date }}>
                                                    </div>
                                                </div>
                                                <div class="col-12 gap-1 d-flex align-items-end mb-3">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->enter_visa_file_name }}</label>
                                                        @php
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6 entry-visa-country">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control entry-visa-select"
                                                            id="entry-visa-select" name="enter_visa_country">
                                                            <option selected disabled>select status</option>
                                                            <option value='yes'
                                                                {{ $new_visa_data->enter_visa_country == 'yes' ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value='no'
                                                                {{ $new_visa_data->enter_visa_country == 'no' ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6 d-none Over-stay-fine">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control fine-select" id="select-fine-file"
                                                            ...
                                                            <option value='yes'
                                                                {{ $new_visa_data->enter_visa_over_sf == 'yes' ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value='no'
                                                                {{ $new_visa_data->enter_visa_over_sf == 'no' ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row  align-items-end ">
                                                    <div class=" col-xl-6 col-lg-12 col-md-6 mb-3 align-items-end d-flex">
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                <input type="file" class="form-control"
                                                                    id='over-stay-file' name="enter_visa_osf_file"
                                                                    style="line-height: 1" accept=".pdf,.doc,.excel">
                                                                <div class="input-group-prepend">
                                                                    <small class="input-group-text"><span
                                                                            class="fa fa-paperclip"></span></small>
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="start-process-transaction-number5">Transaction
                                                            No:</label>
                                                        <input type="text" class="form-control"
                                                            id="start-process-transaction-number5" disabled
                                                            placeholder="..."
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="change-date"
                                                            ...
                                                            value="{{ $new_visa_data->change_of_visa_date }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->change_of_visa_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $new_visa_data->medical_fitness_tno }}"
                                                            placeholder="...">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="#change-transaction-date">Date</label>
                                                        <input type="date" class="form-control" id="change-date"
                                                            disabled value="{{ $new_visa_data->medical_fitness_date }}"
                                                            placeholder="...">
                                                    </div>
                                                </div>
                                                <div class=" col-xl-6 col-lg-12 col-md-6 mb-3 align-items-end d-flex">
                                ...
                                <div class="tab-pane fade" id="v-pills-visa7" role="tabpanel"
                                    ...
                                    <div class='rounded p-3 light-box-shadow'>
                                        <form
                                            action="{{ route('company.new-visa-updation-company', $new_visa_data->id) }}"
                                            class='py-2' method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 tawjeeh-parent col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select-tawjeeh-payment"
                                                            ...
                                                            <option value='yes'
                                                                {{ $new_visa_data->tawjeeh_payment == 'yes' ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value='no'
                                                                {{ $new_visa_data->tawjeeh_payment == 'no' ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='visa-tawjeeh-medical' name="tawjeeh_file"
                                                                style="line-height: 1" accept=".pdf,.doc,.excel">
                                                            <div class="input-group-prepend">
                                                                <small class="input-group-text"><span
                                                                        class="fa fa-paperclip"></span></small>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="tawjeeh-date"
                                                            placeholder="..."
                                                            value="{{ $new_visa_data->contract_date }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->contract_file_name }}</label>
                                                        @php
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            ...
                                                            value="{{ $new_visa_data->health_insur_date }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->health_insur_file_name }}</label>
                                                        @php
                                        ...
                                        <form action="" class='py-2'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->work_permit_file_name }}</label>
                                                        @php
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            ...
                                                            value="{{ $new_visa_data->emirates_date }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->emirates_file_name }}</label>
                                                        @php
                                        ...
                                        <form action="" class='pt-4 pb-2'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $new_visa_data->residency_file_name }}</label>
                                                        @php
                                                ...
                                                <div class="col-xl-6 col-lg-12 biometric-select-parent col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control biometric-select"
                                                            id="select-biometric" name="employee_biometric">
                                                            <option selected disabled>Select Option</option>
                                                            <option value='required'
                                                                {{ $new_visa_data->employee_biometric == 'required' ? 'selected' : '' }}>
                                                                Required</option>
                                                            <option value='not required'
                                                                {{ $new_visa_data->employee_biometric == 'not required' ? 'selected' : '' }}>
                                                                Not Required</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6 biometric-files-container d-none">
                                                    <div class="mb-3 align-items-end d-flex">
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                <input type="file" class="form-control"
                                                                    id='visa2-file-bio' name="biometric_file"
                                                                    style="line-height: 1" accept=".pdf,.doc,.excel">
                                                                <div class="input-group-prepend">
                                                                    <small class="input-group-text"><span
                                                                            class="fa fa-paperclip"></span></small>
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="renewal-medical-fee" disabled
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="renewal-process1-date" disabled
                                                            value="{{ $renewal_process_data->medical_fitness_date }}"
                                                            placeholder="...">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6 renewal-fitness-parent">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control renewal-fitness"
                                                            id="fitness-renewal" name="medical_fitness_st">
                                                            ...
                                                            <option value="not fit"
                                                                {{ $renewal_process_data['medical_fitness_st'] == 'not fit' ? 'selected' : '' }}>
                                                                Not Fit</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="renewal-process2-date" placeholder="..." disabled
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $renewal_process_data->work_permit_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="renewal-process3-date" placeholder="..." disabled
                                                ...
                                                <div class=" col-xl-6 col-lg-12 col-md-6 mb-3 align-items-end d-flex">
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='renewal-process-file' name="signed_mb_file"
                                                                style="line-height: 1" accept=".pdf,.doc,.excel">
                                                            <div class="input-group-prepend">
                                                                <small class="input-group-text"><span
                                                                        class="fa fa-paperclip"></span></small>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="#start-process-transaction-number12">Transaction
                                                            No:</label>
                                                        <input type="text" class="form-control"
                                                            id="start-process-transaction-number12" disabled
                                                            placeholder="..."
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="#start-process-transaction-fee12">Transaction
                                                            Fee</label>
                                                        <input type="text" class="form-control"
                                                            id="start-process-transaction-fee12" disabled
                                                            placeholder="..."
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="#renewal-process3-date">Date</label>
                                                        <input type="date" class="form-control"
                                                            id="renewal-process3-date" disabled placeholder="..."
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $renewal_process_data->pay_dubai_insu_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="#renewal-process3-date">Date</label>
                                                        <input type="date" class="form-control"
                                                            id="renewal-process3-date" disabled
                                                            value="{{ $renewal_process_data->contract_sub_date }}"
                                                            placeholder="...">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $renewal_process_data->contract_sub_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control renewal-tawjeeh-payment-select1"
                                                            ...
                                                            name="tawjeeh_tranc_payment">
                                                            <option selected disabled>Select Option</option>
                                                            <option
                                                                value='yes'{{ $renewal_process_data['tawjeeh_tranc_payment'] == 'yes' ? 'selected' : '' }}>
                                                                Yes</option>
                                                            <option value='no'
                                                                {{ $renewal_process_data['tawjeeh_tranc_payment'] == 'no' ? 'selected' : '' }}>
                                                                No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='renewal-tawjeeh-payment' name="tawjeeh_tranc_file"
                                                                style="line-height: 1" accept=".pdf,.doc,.excel">
                                                            <div class="input-group-prepend">
                                                                <small class="input-group-text"><span
                                                                        class="fa fa-paperclip"></span></small>
                                        ...
                                        <form action="" class='py-2'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $renewal_process_data->residency_file_name }}</label>
                                                        @php
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            id="renewal7_1-date" disabled placeholder="..."
                                                            value="{{ $renewal_process_data->renewal_date }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 gap-1 d-flex align-items-end col-md-6">
                                                    <div class="d-flex flex-column">
                                                        <label
                                                            for="#">{{ $renewal_process_data->renewal_file_name }}</label>
                                                        @php
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="renewal-process-transaction-number12">Transaction
                                                            No:</label>
                                                        <input type="text" class="form-control"
                                                            id="renewal-process-transaction-number12"disabled
                                                            placeholder="..."
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="renewal-process-transaction-fee12">Transaction
                                                            Fee</label>
                                                        <input type="text" class="form-control"
                                                            id="renewal-process-transaction-fee12"disabled
                                                            placeholder="..."
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control biometric-select"
                                                            ...
                                                            <option value='required'
                                                                ...
                                                                Required</option>
                                                            <option value='not required'
                                                                {{ $renewal_process_data['emp_biometric'] == 'not required' ? 'selected' : '' }}>
                                                                Not Required</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6 biometric-files-container d-none">
                                                    <div class="mb-3 align-items-end d-flex">
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                <input type="file" class="form-control"
                                                                    id='renewal-file-bio' name="emp_biometric_file"
                                                                    style="line-height: 1" accept=".pdf,.doc,.excel">
                                                                <div class="input-group-prepend">
                                                                    <small class="input-group-text"><span
                                                                            class="fa fa-paperclip"></span></small>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="sponsor1-date" disabled
                                                                    value="{{ $spo_by_some->work_permit_app_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $spo_by_some->work_permit_app_file_name }}</label>
                                                                @php
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="#sponsor2-date" disabled
                                                                    value="{{ $spo_by_some->signed_mb_st_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-3 col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="upload-file">
                                                                ...
                                                                <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                    <input type="file" class="form-control"
                                                                        id='visa2-file_2_1' name="signed_mb_st_file"
                                                                        style="line-height: 1"
                                                                        accept=".pdf,.doc,.excel">
                                                                    <div class="input-group-prepend">
                                                                        <small class="input-group-text"><span
                                        ...
                                        <div class="tab-pane fade" id="v-pills-sponsored2-1" role="tabpanel"
                                            ...
                                            <div class='rounded p-3 light-box-shadow'>
                                                <form
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            class="col-xl-6 col-lg-12 col-md-6 new-visa-signmbstatus-parent">
                                                            <div class="form-group mb-3 ">
                                                        ...
                                                        <div
                                                            class="form-group col-12 d-none new-visa-signmbstatus-comment">
                                                            <label
                                                                for='visa3_12-transaction-textareara-13'>Comments</label>
                                                            <textarea type="text" id='visa3_12-transaction-textarear-13' name="comment" name=""
                                                                placeholder="Enter Your Comments ..." class="form-control" rows="5">{{ $spo_by_some->waiting_for_approval_reason }}</textarea>
                                                        </div>
                                                        <div
                                                            class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                            <div class="form-group mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="sponsor3-date" disabled
                                                                    value="{{ $spo_by_some->pay_dubai_insu_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $spo_by_some->pay_dubai_insu_file_name }}</label>
                                                                @php
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="sponsor4-date" disabled
                                                                    value="{{ $spo_by_some->pre_approv_wp_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $spo_by_some->pre_approv_wp_file_name }}</label>
                                                                @php
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="sponsor4-date" disabled
                                                                    value="{{ $spo_by_some->upload_wp_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $spo_by_some->upload_wp_file_name }}</label>
                                                                @php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $part_time->wp_app_trnc_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $part_time->wp_app_trnc_fee }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-0 col-xl-6 col-lg-12 col-md-6 ">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="part-time1-date" disabled
                                                                    value="{{ $part_time->wp_app_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $part_time->wp_app_file_name }}</label>
                                                                @php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $part_time->signed_mb_st_trc_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="#parttime2-date" disabled
                                                                    value="{{ $part_time->signed_mb_st_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-3 col-12">
                                                ...
                                                <form action="{{ route('company.part-time-company', $part_time->id) }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <textarea type="text" id='sponsor2_14-textarear-13' name="comment" disabled
                                                                placeholder="Enter Your Comments ..." class="form-control" rows="5">{{ $part_time->waiting_for_approval_reason }}</textarea>
                                                        </div>
                                                        <div
                                                            class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                            <div class="form-group mb-3">
                                                                <label for="sponsor-approval-13">Approval No:</label>
                                                                <input type="text" class="form-control"
                                                                    id="sponsor-approval-13" disabled
                                                                    value="{{ $part_time->waiting_for_approval_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="partime-4-number-1" disabled
                                                                    value="{{ $part_time->contract_tran_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $part_time->contract_tran_fee }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="partime-4-date-1" disabled
                                                                    value="{{ $part_time->contract_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $part_time->contract_file_name }}</label>
                                                                @php
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    ...
                                                                    value="{{ $uae_national->wp_app_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $uae_national->wp_app_file_name }}</label>
                                                                @php
                                                ...
                                                <form action="{{ route('company.uae-gcc-company', $uae_national->id) }}"
                                                    ...
                                                    <div class="row align-items-end">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label
                                                                    for="#upload-signed-uae2-mb-transaction-fee">Transaction
                                                                    Fee</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="upload-file">
                                                                ...
                                                                <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                    <input type="file" class="form-control"
                                                                        id='visa2-file-3-1' name="signed_mb_st_file"
                                                                        style="line-height: 1"
                                                                        accept=".pdf,.doc,.excel">
                                                                    <div class="input-group-prepend">
                                                                        <small class="input-group-text"><span
                                            ...
                                            <form action="{{ route('company.uae-gcc-company', $uae_national->id) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-12 d-none new-visa-signmbstatus-comment">
                                                        ...
                                                        <textarea type="text" id='sponsor2-textarear1-13' readonly name="waiting_for_approval_reason"
                                                            placeholder="Enter Your Comments ..." class="form-control" rows="5">{{ $uae_national->waiting_for_approval_reason }}</textarea>
                                                    </div>
                                                    <div
                                                        class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="sponsor-approval1-13"
                                                                value="{{ $uae_national->waiting_for_approval_no }}"
                                                ...
                                                <form action="" class='py-2'>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label
                                                                    for="#UAE4-process-transaction-number10">Transaction
                                                                    No:</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">value="{{ $uae_national->upload_wp_file_name }}"</label>
                                                                @php
                                ...
                                <div class="tab-content" id="modify-contract-tabContent">
                                    ...
                                    @if ($modify_contract)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="modify1-number1"
                                                                    value="{{ $modify_contract->wp_app_trnc_no }}"
                                                                    disabled placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="modify1-fee1"
                                                                    value="{{ $modify_contract->wp_app_trnc_fee }}"
                                                                    disabled placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-0 col-xl-6 col-lg-12 col-md-6 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $modify_contract->wp_app_file_name }}</label>
                                                                @php
                                        ...
                                        <div class="tab-pane fade" id="v-pills-modify-contract2" role="tabpanel"
                                            ...
                                            <div class='rounded p-3 light-box-shadow'>
                                                <form
                                                    action="{{ route('company.modify-contract-company', $uae_national->id) }}"
                                                    class='py-2' method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="text" value='step1' name='signed_mb' hidden>
                                                    <h6 class="mb-3"><span class="fa fa-solid fa-folder"></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="modify2-number1" disabled
                                                                    value="{{ $modify_contract->signed_mb_st_trc_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="#modify2-date" disabled
                                                                    value="{{ $modify_contract->signed_mb_st_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="upload-file">
                                                                ...
                                                                <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                                    <input type="file" class="form-control"
                                                                        id='visa2-file' name="signed_mb_st_file"
                                                                        style="line-height: 1"
                                                                        accept=".pdf,.doc,.excel">
                                                                    <div class="input-group-prepend">
                                                                        <small class="input-group-text"><span
                                                ...
                                                <form action="{{ route('company.uae-gcc-company', $uae_national->id) }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <textarea type="text" id='sponsor21-textarear-13' name="waiting_for_approval_reason"
                                                                placeholder="Enter Your Comments ..." disabled class="form-control" rows="5">{{ $modify_contract->waiting_for_approval_reason }}</textarea>
                                                        </div>
                                                        <div
                                                            class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                            <div class="form-group mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $modify_contract->upload_wp_tranc_no }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="modify5-fee10" disabled
                                                                    value="{{ $modify_contract->upload_wp_tranc_fee }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-xl-6 col-lg-12 col-md-6 ">
                                                        ...
                                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="modify5-date" disabled
                                                                    value="{{ $modify_contract->upload_wp_date }}"
                                                                    placeholder="...">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <label
                                                                    for="#">{{ $modify_contract->upload_wp_file_name }}</label>
                                                                @php
                                        ...
                                        <form
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 d-none new-visa-signmbstatus-comment">
                                                    ...
                                                    <textarea type="text" id='sponsor2-textarear32-13' name="comment" placeholder="Enter Your Comments ..."
                                                        disabled class="form-control" rows="5">{{ $modification_visa->application_reject_reason }}</textarea>
                                                </div>
                                                <div
                                                    class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" disabled
                                                            ...
                                                            class="form-control" id="sponsor-approval32-13"
                                                            placeholder="...">
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='visa232-file-bio_1'
                                                                name="application_reject_reason_file"
                                                                style="line-height: 1" accept=".pdf,.doc,.excel">
                                                            <div class="input-group-prepend">
                                                                <small class="input-group-text"><span
                                                                        class="fa fa-paperclip"></span></small>
                                        ...
                                        <form
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 d-none new-visa-signmbstatus-comment">
                                                    ...
                                                    <textarea type="text" id='sponsor2-textarear3-2-13' name="comment" placeholder="Enter Your Comments ..."
                                                        class="form-control" disabled rows="5">{{ $modification_emirates->application_reject_reason }}</textarea>
                                                </div>
                                                <div
                                                    class="col-xl-6 col-lg-12 col-md-6 d-none new-visa-signmbstatus-approval">
                                                    <div class="form-group mb-3">
