                                        ...
                                        <div class="col-sm-6 pl-sm-0 pr-sm-2">
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="religion" class="form-control" id="selReligion">
                                                    ...
                                                    <option value="Judaism" {{ $data['religion'] == 'Judaism' ? 'selected' : '' }}>Judaism</option>
                                                    ...
                                                    <option value="Atheist" {{ $data['religion'] == 'Atheist' ? 'selected' : '' }}>Atheist</option>
                                                    <option value="Baha'i" {{ $data['religion'] == "Baha'i" ? 'selected' : '' }}>Baha'i</option>
                                                    <option value="Buddhism" {{ $data['religion'] == 'Buddhism' ? 'selected' : '' }}>Buddhism</option>
                                                    <option value="Sikhism" {{ $data['religion'] == 'Sikhism' ? 'selected' : '' }}>Sikhism</option>
                                                    <option value="Spiritism" {{ $data['religion'] == 'Spiritism' ? 'selected' : '' }}>Spiritism</option>
                                                    <option value="Tenrikyo" {{ $data['religion'] == 'Tenrikyo' ? 'selected' : '' }}>Tenrikyo</option>
                                                </select>
                                                @error('religion')
                                                    <div class="text-danger p-2">{{ $message }}</div>
                                                @enderror
