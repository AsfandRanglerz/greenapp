                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                ...
                                <a class="btn btn-success mb-3" href="{{ route('dependent-document-create', $id) }}">Add
                                    Document</a>
                                        ...
                                        @foreach ($documents as $document)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="btn btn-success" href="{{ route('dependent-document-download', $ext[1]) }}"><span
                                                        class="fa fa-download text-white"></span></a>
                                                    <a class="btn btn-info"
                                                        href="{{ route('dependent-document-edit', $document->id) }}">Edit</a>
                                                    <form method="get"
                                                        action="{{ route('dependent-document-delete', $document->id) }}">
                                                        @csrf
