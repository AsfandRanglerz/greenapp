    ...
    <div class="mb-5 admin-main-content-inner">
        ...
        <ul class="nav nav-tabs nav-bar horizontal_tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active tab-1" id="home-tab" data-toggle="tab" href="#home" role="tab"
                    aria-controls="home" aria-selected="true">
                    New Visa
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link tab-2" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                    aria-controls="profile" aria-selected="false">
                    Renewal Process
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link tab-3" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                    aria-controls="contact" aria-selected="false">Modification of Visa</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link tab-4" id="modify-id-tab" data-toggle="tab" href="#modify-id" role="tab"
                    aria-controls="modify" aria-selected="false">Modification of Emirates ID</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link tab-5" id="cancelation-tab" data-toggle="tab" href="#cancelation" role="tab"
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="nav side-bar flex-row horizontal_tabs flex-lg-column nav-pills" id="v-pills-tab"
                            ...
                            <a class="nav-link active bordered_tab" id="v-pills-start-tab" data-toggle="pill"
                                ...
                                Process</a>
                            <a class="nav-link bordered_tab" id="v-pills-entry-tab" data-toggle="pill"
                                href="#v-pills-entry" role="tab" aria-controls="v-pills-entry"
                        ...
                        <div class="tab-content" id="visa-tabContent">
                            <div class="tab-pane fade show active process-starter" id="v-pills-start" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('admin-start-visa-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id']])}}"
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-1-id" placeholder="..." disabled
                                                    ...
                                                    @else
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-1-id" placeholder="..." disabled value="not started">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-entry" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('dependent-new-visa-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id'],'process_id'=>$new_visa->id])}}"
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-7"
                                                        value="{{$new_visa->enter_visa_ts_no}}" name="enter_visa_ts_no"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-8"
                                                        value="{{$new_visa->enter_visa_ts_fee}}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select id="visa-id-9"
                                                        ...
                                                        <option value="Approved"
                                                            {{$new_visa['enter_visa_status']=='Approved' ? 'selected'
                                                            : '' }}>Approved</option>
                                                        <option value="UnderProcess"
                                                            {{$new_visa['enter_visa_status']=='UnderProcess'
                                                            ? 'selected' : '' }}>Under Process</option>
                                                        <option value="Skip" {{$new_visa['enter_visa_status']=='Skip'
                                                            ? 'selected' : '' }}>Skip</option>
                                                        <option value="Reject"
                                                            {{$new_visa['enter_visa_status']=='Reject' ? 'selected' : ''
                                                            }}>Reject</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa-id-10"
                                                        name="enter_visa_date" value="{{$new_visa->enter_visa_date}}"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 form-group col-lg-12 col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-visa-8">Select File</label>
                                                <select id="new-visa-8" class="form-control category"
                                                    name="enter_visa_file_name">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['enter_visa_file_name']=='Personal Photo' ? 'selected'
                                                        : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['enter_visa_file_name']=='Passport' ? 'selected' : ''
                                                        }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['enter_visa_file_name']=='Visit Visa' ? 'selected'
                                                        : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['enter_visa_file_name']=='Offer Letter' ? 'selected'
                                                        : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['enter_visa_file_name']=='MOL Job Offer' ? 'selected'
                                                        : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['enter_visa_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['enter_visa_file_name']=='MOL MB Contract'
                                                        ? 'selected' : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['enter_visa_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['enter_visa_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['enter_visa_file_name']=='Dubai Insurance'
                                                        ? 'selected' : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['enter_visa_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['enter_visa_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['enter_visa_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Tawjeeh Receipt'
                                                        ? 'selected' : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['enter_visa_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['enter_visa_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['enter_visa_file_name']=='Residence Visa' ? 'selected'
                                                        : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['enter_visa_file_name']=='Work Permit' ? 'selected'
                                                        : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['enter_visa_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['enter_visa_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['enter_visa_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['enter_visa_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['enter_visa_file_name']=='Driving License'
                                                        ? 'selected' : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['enter_visa_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['enter_visa_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['enter_visa_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['enter_visa_file_name']=='Diploma' ? 'selected' : ''
                                                        }}>Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['enter_visa_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['enter_visa_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['enter_visa_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['enter_visa_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['enter_visa_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['enter_visa_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['enter_visa_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['enter_visa_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['enter_visa_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['enter_visa_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['enter_visa_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['enter_visa_file_name']=='Submission Form'
                                                        ? 'selected' : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['enter_visa_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['enter_visa_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['enter_visa_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['enter_visa_file_name']=='Medical' ? 'selected' : ''
                                                        }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['enter_visa_file_name']=='Tawjeeh' ? 'selected' : ''
                                                        }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['enter_visa_file_name']=='Heath Insurance'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['enter_visa_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['enter_visa_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['enter_visa_file_name']=='Visa Fines' ? 'selected'
                                                        : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['enter_visa_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['enter_visa_file_name']=='Other fines' ? 'selected'
                                                        : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['enter_visa_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['enter_visa_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['enter_visa_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{ $new_visa['enter_visa_file_name']=='Other'
                                                        ? 'selected' : '' }}>Other
                                                    </option> -->
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-14"
                                                        value="{{$new_visa->change_of_visa_tno}}"
                                                        name="change_of_visa_tno" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-15"
                                                        value="{{$new_visa->change_of_visa_tfee}}"
                                                        name="change_of_visa_tfee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="visa-id-16">Status</label>
                                                    <select id="visa-id-16"
                                                        class="form-control status-selector-select category"
                                                        name="change_of_visa_status">
                                                        <option value="" selected disabled>select</option>
                                                        <option value="Approved"
                                                            {{$new_visa['change_of_visa_status']=='Approved'
                                                            ? 'selected' : '' }}>Approved</option>
                                                        <option value="UnderProcess"
                                                            {{$new_visa['change_of_visa_status']=='UnderProcess'
                                                            ? 'selected' : '' }}>Under Process</option>
                                                        <option value="Skip"
                                                            {{$new_visa['change_of_visa_status']=='Skip' ? 'selected'
                                                            : '' }}>Skip</option>
                                                        <option value="Reject"
                                                            {{$new_visa['change_of_visa_status']=='Reject' ? 'selected'
                                                            : '' }}>Reject</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa-id-17"
                                                        value="{{$new_visa->change_of_visa_date}}"
                                                        name="change_of_visa_date" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-visa4-8">Select File</label>
                                                <select id="new-visa-8" class="form-control category"
                                                    name="change_of_visa_file_name">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['change_of_visa_file_name']=='Personal Photo'
                                                        ? 'selected' : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['change_of_visa_file_name']=='Passport' ? 'selected'
                                                        : '' }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['change_of_visa_file_name']=='Visit Visa' ? 'selected'
                                                        : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['change_of_visa_file_name']=='Offer Letter'
                                                        ? 'selected' : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['change_of_visa_file_name']=='MOL Job Offer'
                                                        ? 'selected' : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['change_of_visa_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['change_of_visa_file_name']=='MOL MB Contract'
                                                        ? 'selected' : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['change_of_visa_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['change_of_visa_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['change_of_visa_file_name']=='Dubai Insurance'
                                                        ? 'selected' : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['change_of_visa_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['change_of_visa_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['change_of_visa_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Tawjeeh Receipt'
                                                        ? 'selected' : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['change_of_visa_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['change_of_visa_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['change_of_visa_file_name']=='Residence Visa'
                                                        ? 'selected' : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['change_of_visa_file_name']=='Work Permit'
                                                        ? 'selected' : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['change_of_visa_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['change_of_visa_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['change_of_visa_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['change_of_visa_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['change_of_visa_file_name']=='Driving License'
                                                        ? 'selected' : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['change_of_visa_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['change_of_visa_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['change_of_visa_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['change_of_visa_file_name']=='Diploma' ? 'selected'
                                                        : '' }}>Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['change_of_visa_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['change_of_visa_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['change_of_visa_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['change_of_visa_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['change_of_visa_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['change_of_visa_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['change_of_visa_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['change_of_visa_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['change_of_visa_file_name']=='Submission Form'
                                                        ? 'selected' : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['change_of_visa_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['change_of_visa_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['change_of_visa_file_name']=='Medical' ? 'selected'
                                                        : '' }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['change_of_visa_file_name']=='Tawjeeh' ? 'selected'
                                                        : '' }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['change_of_visa_file_name']=='Heath Insurance'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['change_of_visa_file_name']=='Visa Fines' ? 'selected'
                                                        : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['change_of_visa_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['change_of_visa_file_name']=='Other fines'
                                                        ? 'selected' : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['change_of_visa_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['change_of_visa_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['change_of_visa_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{
                                                        $new_visa['change_of_visa_file_name']=='Other' ? 'selected' : ''
                                                        }}>Other
                                                    </option>
                                                </select>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-health-insurance" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        ...
                                        <h6 class="mb-3"><span class="fa fa-solid fa-folder"></span> Health Insurance
                                        </h6>
                                        <div class="row align-items-end fine-select-container">
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-18"
                                                        value="{{$new_visa->health_insur_tran_no}}"
                                                        name="health_insur_tran_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-19"
                                                        value="{{$new_visa->health_insur_tran_fee}}"
                                                        name="health_insur_tran_fee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="visa-id-20">Status</label>
                                                    <select id="visa-id-20"
                                                        class="form-control status-selector-select category"
                                                        name="health_insur_status">
                                                        <option value="" selected disabled>select</option>
                                                        <option value="Approved"
                                                            {{$new_visa['health_insur_status']=='Approved' ? 'selected'
                                                            : '' }}>Approved</option>
                                                        <option value="UnderProcess"
                                                            {{$new_visa['health_insur_status']=='UnderProcess'
                                                            ? 'selected' : '' }}>Under Process</option>
                                                        <option value="Skip" {{$new_visa['health_insur_status']=='Skip'
                                                            ? 'selected' : '' }}>Skip</option>
                                                        <option value="Reject"
                                                            {{$new_visa['health_insur_status']=='Reject' ? 'selected'
                                                            : '' }}>Reject</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa-id-21"
                                                        value="{{$new_visa->health_insur_date}}"
                                                        name="health_insur_date" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group mb-3 col-md-6 gap-1 align-items-end">
                                                <label for="new-visa5-8">Select File</label>
                                                <select id="new-visa-8" class="form-control category"
                                                    name="health_insur_file_name">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['health_insur_file_name']=='Personal Photo'
                                                        ? 'selected' : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['health_insur_file_name']=='Passport' ? 'selected'
                                                        : '' }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['health_insur_file_name']=='Visit Visa' ? 'selected'
                                                        : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['health_insur_file_name']=='Offer Letter' ? 'selected'
                                                        : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['health_insur_file_name']=='MOL Job Offer'
                                                        ? 'selected' : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['health_insur_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['health_insur_file_name']=='MOL MB Contract'
                                                        ? 'selected' : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['health_insur_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['health_insur_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['health_insur_file_name']=='Dubai Insurance'
                                                        ? 'selected' : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['health_insur_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['health_insur_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['health_insur_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['health_insur_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['health_insur_file_name']=='Tawjeeh Receipt'
                                                        ? 'selected' : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['health_insur_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['health_insur_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['health_insur_file_name']=='Residence Visa'
                                                        ? 'selected' : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['health_insur_file_name']=='Work Permit' ? 'selected'
                                                        : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['health_insur_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['health_insur_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['health_insur_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['health_insur_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['health_insur_file_name']=='Driving License'
                                                        ? 'selected' : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['health_insur_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['health_insur_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['health_insur_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['health_insur_file_name']=='Diploma' ? 'selected' : ''
                                                        }}>Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['health_insur_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['health_insur_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['health_insur_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['health_insur_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['health_insur_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['health_insur_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['health_insur_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['health_insur_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['health_insur_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['health_insur_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['health_insur_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['health_insur_file_name']=='Submission Form'
                                                        ? 'selected' : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['health_insur_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['health_insur_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['health_insur_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['health_insur_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['health_insur_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['health_insur_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['health_insur_file_name']=='Medical' ? 'selected' : ''
                                                        }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['health_insur_file_name']=='Tawjeeh' ? 'selected' : ''
                                                        }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['health_insur_file_name']=='Heath Insurance'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['health_insur_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['health_insur_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['health_insur_file_name']=='Visa Fines' ? 'selected'
                                                        : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['health_insur_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['health_insur_file_name']=='Other fines' ? 'selected'
                                                        : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['health_insur_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['health_insur_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['health_insur_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{
                                                        $new_visa['health_insur_file_name']=='Other' ? 'selected' : ''
                                                        }}>Other
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-22"
                                                        value="{{$new_visa->medical_fitness_tno}}"
                                                        name="medical_fitness_tno" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-23"
                                                        value="{{$new_visa->medical_fitness_tfee}}"
                                                        name="medical_fitness_tfee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group col-xl-6 col-lg-12 col-md-6 mb-3">
                                                <label for="visa-id-24">Status</label>
                                                <select id="visa-id-24"
                                                    class="form-control status-selector-select category"
                                                    name="medical_fitness_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        {{$new_visa['medical_fitness_status']=='Approved' ? 'selected'
                                                        : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$new_visa['medical_fitness_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip" {{$new_visa['medical_fitness_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$new_visa['medical_fitness_status']=='Reject' ? 'selected'
                                                        : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa-id-25"
                                                        value="{{$new_visa->medical_fitness_date}}"
                                                        name="medical_fitness_date" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-visa6-8">Select File</label>
                                                <select id="new-visa-8" class="form-control category"
                                                    name="medical_fitness_file_name">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['medical_fitness_file_name']=='Personal Photo'
                                                        ? 'selected' : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['medical_fitness_file_name']=='Passport' ? 'selected'
                                                        : '' }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['medical_fitness_file_name']=='Visit Visa'
                                                        ? 'selected' : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['medical_fitness_file_name']=='Offer Letter'
                                                        ? 'selected' : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['medical_fitness_file_name']=='MOL Job Offer'
                                                        ? 'selected' : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['medical_fitness_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['medical_fitness_file_name']=='MOL MB Contract'
                                                        ? 'selected' : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['medical_fitness_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['medical_fitness_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['medical_fitness_file_name']=='Dubai Insurance'
                                                        ? 'selected' : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['medical_fitness_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['medical_fitness_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['medical_fitness_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Tawjeeh Receipt'
                                                        ? 'selected' : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['medical_fitness_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['medical_fitness_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['medical_fitness_file_name']=='Residence Visa'
                                                        ? 'selected' : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['medical_fitness_file_name']=='Work Permit'
                                                        ? 'selected' : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['medical_fitness_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['medical_fitness_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['medical_fitness_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['medical_fitness_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['medical_fitness_file_name']=='Driving License'
                                                        ? 'selected' : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['medical_fitness_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['medical_fitness_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['medical_fitness_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['medical_fitness_file_name']=='Diploma' ? 'selected'
                                                        : '' }}>Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['medical_fitness_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['medical_fitness_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['medical_fitness_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['medical_fitness_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['medical_fitness_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['medical_fitness_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['medical_fitness_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['medical_fitness_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['medical_fitness_file_name']=='Submission Form'
                                                        ? 'selected' : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['medical_fitness_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['medical_fitness_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['medical_fitness_file_name']=='Medical' ? 'selected'
                                                        : '' }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['medical_fitness_file_name']=='Tawjeeh' ? 'selected'
                                                        : '' }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['medical_fitness_file_name']=='Heath Insurance'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['medical_fitness_file_name']=='Visa Fines'
                                                        ? 'selected' : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['medical_fitness_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['medical_fitness_file_name']=='Other fines'
                                                        ? 'selected' : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['medical_fitness_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['medical_fitness_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['medical_fitness_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{
                                                        $new_visa['medical_fitness_file_name']=='Other' ? 'selected'
                                                        : '' }}>Other
                                                    </option>
                                                </select>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-residency-id" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        ...
                                        enctype="multipart/form-data" method="POST" class='py-2'>
                                        @csrf
                                        <input type="hidden" value="emirates_residency_app"
                                            name="emirates_residency_app">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-28"
                                                        value="{{$new_visa->emirates_tran_no}}" name="emirates_tran_no"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-29"
                                                        value="{{$new_visa->emirates_tran_fee}}"
                                                        name="emirates_tran_fee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group col-xl-6 col-lg-12 col-md-6 mb-3">
                                                <label for="visa-id-31">Status</label>
                                                <select id="visa-id-31"
                                                    class="form-control status-selector-select category"
                                                    name="emirates_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved" {{$new_visa['emirates_status']=='Approved'
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$new_visa['emirates_status']=='UnderProcess' ? 'selected' : ''
                                                        }}>Under Process</option>
                                                    <option value="Skip" {{$new_visa['emirates_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject" {{$new_visa['emirates_status']=='Reject'
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        id="emirates-transaction-date"
                                                        value="{{$new_visa->emirates_date}}" name="emirates_date"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-visa6-9">Select File</label>
                                                <select id="new-visa-8" class="form-control category"
                                                    name="emirates_file_name">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['emirates_file_name']=='Personal Photo' ? 'selected'
                                                        : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['emirates_file_name']=='Passport' ? 'selected' : ''
                                                        }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['emirates_file_name']=='Visit Visa' ? 'selected' : ''
                                                        }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['emirates_file_name']=='Offer Letter' ? 'selected'
                                                        : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['emirates_file_name']=='MOL Job Offer' ? 'selected'
                                                        : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['emirates_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['emirates_file_name']=='MOL MB Contract' ? 'selected'
                                                        : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['emirates_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['emirates_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['emirates_file_name']=='Dubai Insurance' ? 'selected'
                                                        : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['emirates_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['emirates_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['emirates_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['emirates_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['emirates_file_name']=='Tawjeeh Receipt' ? 'selected'
                                                        : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['emirates_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['emirates_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['emirates_file_name']=='Residence Visa' ? 'selected'
                                                        : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['emirates_file_name']=='Work Permit' ? 'selected' : ''
                                                        }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['emirates_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['emirates_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['emirates_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['emirates_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['emirates_file_name']=='Driving License' ? 'selected'
                                                        : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['emirates_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['emirates_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['emirates_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['emirates_file_name']=='Diploma' ? 'selected' : '' }}>
                                                        Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['emirates_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['emirates_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['emirates_file_name']=='Tenancy Contract' ? 'selected'
                                                        : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['emirates_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['emirates_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['emirates_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['emirates_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['emirates_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['emirates_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['emirates_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['emirates_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['emirates_file_name']=='Submission Form' ? 'selected'
                                                        : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['emirates_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['emirates_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['emirates_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['emirates_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['emirates_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['emirates_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['emirates_file_name']=='Medical' ? 'selected' : '' }}>
                                                        Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['emirates_file_name']=='Tawjeeh' ? 'selected' : '' }}>
                                                        Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['emirates_file_name']=='Heath Insurance' ? 'selected'
                                                        : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['emirates_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['emirates_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['emirates_file_name']=='Visa Fines' ? 'selected' : ''
                                                        }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['emirates_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['emirates_file_name']=='Other fines' ? 'selected' : ''
                                                        }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['emirates_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['emirates_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['emirates_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{ $new_visa['emirates_file_name']=='Other'
                                                        ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-32"
                                                        value="{{$new_visa->residency_tran_no}}"
                                                        name="residency_tran_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-id-33"
                                                        value="{{$new_visa->residency_tran_fee}}"
                                                        name="residency_tran_fee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group col-xl-6 col-lg-12 col-md-6 mb-3">
                                                <label for="visa-id-34">Status</label>
                                                <select id="visa-id-34"
                                                    class="form-control status-selector-select category"
                                                    name="residency_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved" {{$new_visa['residency_status']=='Approved'
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$new_visa['residency_status']=='UnderProcess' ? 'selected'
                                                        : '' }}>Under Process</option>
                                                    <option value="Skip" {{$new_visa['residency_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject" {{$new_visa['residency_status']=='Reject'
                                                        ? 'selected' : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" placeholder=".."
                                                        value="{{$new_visa->residency_date}}" name="residency_date"
                                            ...
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                ...
                                                <select id="new-visa-8" class="form-control category"
                                                    ...
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo" {{
                                                        $new_visa['residency_file_name']=='Personal Photo' ? 'selected'
                                                        : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport" {{
                                                        $new_visa['residency_file_name']=='Passport' ? 'selected' : ''
                                                        }}>
                                                        Passport</option>
                                                    <option value="Visit Visa" {{
                                                        $new_visa['residency_file_name']=='Visit Visa' ? 'selected' : ''
                                                        }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter" {{
                                                        $new_visa['residency_file_name']=='Offer Letter' ? 'selected'
                                                        : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer" {{
                                                        $new_visa['residency_file_name']=='MOL Job Offer' ? 'selected'
                                                        : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer" {{
                                                        $new_visa['residency_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract" {{
                                                        $new_visa['residency_file_name']=='MOL MB Contract' ? 'selected'
                                                        : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer" {{
                                                        $new_visa['residency_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit" {{
                                                        $new_visa['residency_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance" {{
                                                        $new_visa['residency_file_name']=='Dubai Insurance' ? 'selected'
                                                        : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa" {{
                                                        $new_visa['residency_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa" {{
                                                        $new_visa['residency_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status" {{
                                                        $new_visa['residency_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt" {{
                                                        $new_visa['residency_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt" {{
                                                        $new_visa['residency_file_name']=='Tawjeeh Receipt' ? 'selected'
                                                        : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form" {{
                                                        $new_visa['residency_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form" {{
                                                        $new_visa['residency_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa" {{
                                                        $new_visa['residency_file_name']=='Residence Visa' ? 'selected'
                                                        : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit" {{
                                                        $new_visa['residency_file_name']=='Work Permit' ? 'selected'
                                                        : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card" {{
                                                        $new_visa['residency_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card" {{
                                                        $new_visa['residency_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card" {{
                                                        $new_visa['residency_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card" {{
                                                        $new_visa['residency_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License" {{
                                                        $new_visa['residency_file_name']=='Driving License' ? 'selected'
                                                        : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate" {{
                                                        $new_visa['residency_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate" {{
                                                        $new_visa['residency_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate" {{
                                                        $new_visa['residency_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma" {{
                                                        $new_visa['residency_file_name']=='Diploma' ? 'selected' : ''
                                                        }}>Diploma
                                                    </option>
                                                    <option value="University Degree" {{
                                                        $new_visa['residency_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate" {{
                                                        $new_visa['residency_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract" {{
                                                        $new_visa['residency_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form" {{
                                                        $new_visa['residency_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form" {{
                                                        $new_visa['residency_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval" {{
                                                        $new_visa['residency_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval" {{
                                                        $new_visa['residency_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract" {{
                                                        $new_visa['residency_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application" {{
                                                        $new_visa['residency_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application" {{
                                                        $new_visa['residency_file_name']=='Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Work
                                                        Permit Renewal Application</option>
                                                    <option value="Signed Work Permit Renewal Application" {{
                                                        $new_visa['residency_file_name']=='Signed Work Permit Renewal Application'
                                                        ? 'selected' : '' }}>Signed
                                                        Work Permit Renewal Application</option>
                                                    <option value="Submission Form" {{
                                                        $new_visa['residency_file_name']=='Submission Form' ? 'selected'
                                                        : '' }}>Submission Form
                                                    </option>
                                                    <option value="Preapproval of work permit receipt" {{
                                                        $new_visa['residency_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts" {{
                                                        $new_visa['residency_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt" {{
                                                        $new_visa['residency_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt" {{
                                                        $new_visa['residency_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt" {{
                                                        $new_visa['residency_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application" {{
                                                        $new_visa['residency_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical" {{
                                                        $new_visa['residency_file_name']=='Medical' ? 'selected' : ''
                                                        }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh" {{
                                                        $new_visa['residency_file_name']=='Tawjeeh' ? 'selected' : ''
                                                        }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance" {{
                                                        $new_visa['residency_file_name']=='Heath Insurance' ? 'selected'
                                                        : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application" {{
                                                        $new_visa['residency_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application" {{
                                                        $new_visa['residency_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines" {{
                                                        $new_visa['residency_file_name']=='Visa Fines' ? 'selected' : ''
                                                        }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines" {{
                                                        $new_visa['residency_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines" {{
                                                        $new_visa['residency_file_name']=='Other fines' ? 'selected'
                                                        : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines" {{
                                                        $new_visa['residency_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application" {{
                                                        $new_visa['residency_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application" {{
                                                        $new_visa['residency_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other" {{ $new_visa['residency_file_name']=='Other'
                                                        ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-37-id"
                                                        value="{{$new_visa->biometric_tranc_no}}"
                                                        name="biometric_tranc_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa-38-id"
                                                        value="{{$new_visa->biometric_tranc_fee}}"
                                                        name="biometric_tranc_fee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group mb-0 col-xl-6 col-lg-12 col-md-6 mb-3">
                                                <label for="visa-38-id">Status</label>
                                                <select id="visa-38-id"
                                                    class="form-control status-selector-select category"
                                                    name="biometric_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved" {{$new_visa['biometric_status']=='Approved'
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$new_visa['biometric_status']=='UnderProcess' ? 'selected'
                                                        : '' }}>Under Process</option>
                                                    <option value="Skip" {{$new_visa['biometric_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject" {{$new_visa['biometric_status']=='Reject'
                                                        ? 'selected' : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa-39-id"
                                                        value="{{$new_visa->biometric_date}}" name="biometric_date"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control biometric-select" id="visa-40-id"
                                                        ...
                                                        <option value='not required'
                                                            {{$new_visa['employee_biometric']=='not required'
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="nav side-bar flex-row horizontal_tabs flex-lg-column nav-pills" id="v-pills-tab"
                            ...
                            <a class="nav-link bordered_tab" id="v-pills-renewal-medical-fitness-tab" data-toggle="pill"
                                ...
                                aria-controls="v-pills-renewal-medical-fitness" aria-selected="false">Medical
                                Fitness</a>
                            <a class="nav-link bordered_tab" id="v-pills-renewal-residency-id-tab" data-toggle="pill"
                                href="#v-pills-renewal-residency-id" role="tab"
                                aria-controls="v-pills-renewal-residency-id" aria-selected="false">Residency & ID <br
                                    class='d-none d-lg-block'>Renewal
                                Application</a>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tab-content" id="renewal-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    'Approved')
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-2-id" placeholder="..." disabled
                                                        value="process completed">
                                                    ...
                                                    @else
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-2-id" placeholder="..." disabled value="not started">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-renewal-medical-fitness" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('dependent-renewal-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id'],'process_id'=>$renewal_process->id])}}"
                                        enctype="multipart/form-data" method="POST" class='py-2'>
                                        @csrf
                                        <input type="hidden" value="medical_fitness" name="medical_fitness">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa1-id-1"
                                                        ...
                                                        name="medical_fitness_tran_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa1-id-2"
                                                        ...
                                                        name="medical_fitness_tran_fees" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="visa1-id-3_1">Status</label>
                                                    <select id="visa1-id-3_1"
                                                        class="form-control status-selector-select category"
                                                        name="medical_fitness_status">
                                                        <option value="" selected disabled>select</option>
                                                        <option value="Approved"
                                                            {{$renewal_process['medical_fitness_status']=='Approved'
                                                            ? 'selected' : '' }}>Approved</option>
                                                        <option value="UnderProcess"
                                                            {{$renewal_process['medical_fitness_status']=='UnderProcess'
                                                            ? 'selected' : '' }}>Under Process</option>
                                                        <option value="Skip"
                                                            {{$renewal_process['medical_fitness_status']=='Skip'
                                                            ? 'selected' : '' }}>Skip</option>
                                                        <option value="Reject"
                                                            {{$renewal_process['medical_fitness_status']=='Reject'
                                                            ? 'selected' : '' }}>Reject</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6 renewal-fitness-parent">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control renewal-fitness" id="visa1-id-5"
                                                        ...
                                                        <option value="fit"
                                                            {{$renewal_process['medical_fitness_st']=='fit' ? 'selected'
                                                            : '' }}>
                                                            Fit</option>
                                                        <option value="not fit"
                                                            {{$renewal_process['medical_fitness_st']=='not fit'
                                                            ? 'selected' : '' }}>
                                                            Not Fit</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa1-id-7"
                                                        value="{{$renewal_process->residency_tran_no}}"
                                                        name="residency_tran_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visa1-id-8"
                                                        value="{{$renewal_process->residency_tran_fees}}"
                                                        name="residency_tran_fees" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 col-xl-6 col-lg-12 col-md-6 ">
                                                <label for="visa1-id-9">Status</label>
                                                <select id="visa1-id-9"
                                                    class="form-control status-selector-select category"
                                                    name="residency_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        {{$renewal_process['residency_status']=='Approved' ? 'selected'
                                                        : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$renewal_process['residency_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip" {{$renewal_process['residency_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$renewal_process['residency_status']=='Reject' ? 'selected'
                                                        : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="visa1-id-9"
                                                        value="{{$renewal_process->residency_date}}"
                                                        name="residency_date" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                ...
                                                <select id="new-visa-8" class="form-control category"
                                                    ...
                                                    <option value="Passport"
                                                        {{$renewal_process['residency_file_name']=='Passport'
                                                        ? 'selected' : '' }}>
                                                        Passport</option>
                                                    <option value="Visit Visa"
                                                        {{$renewal_process['residency_file_name']=='Visit Visa'
                                                        ? 'selected' : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter"
                                                    ...
                                                    <option value="Work Permit"
                                                        {{$renewal_process['residency_file_name']=='Work Permit'
                                                        ? 'selected' : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card"
                                                    ...
                                                    <option value="School Certificate"
                                                        ...
                                                        Certificate</option>
                                                    <option value="Diploma"
                                                        {{$renewal_process['residency_file_name']=='Diploma'
                                                        ? 'selected' : '' }}>Diploma
                                                    </option>
                                                    <option value="University Degree"
                                                    ...
                                                    <option value="Change of Visa Status Application"
                                                        ...
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical"
                                                        {{$renewal_process['residency_file_name']=='Medical'
                                                        ? 'selected' : '' }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh"
                                                        {{$renewal_process['residency_file_name']=='Tawjeeh'
                                                        ? 'selected' : '' }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance"
                                                    ...
                                                    <option value="Residency Visa Application"
                                                        ...
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines"
                                                        {{$renewal_process['residency_file_name']=='Visa Fines'
                                                        ? 'selected' : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines"
                                                        ...
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines"
                                                        {{$renewal_process['residency_file_name']=='Other fines'
                                                        ? 'selected' : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="{{$renewal_process->renewal_tran_no}}"
                                                        name="renewal_tran_no" class="form-control" id="visa1-id-10"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="{{$renewal_process->renewal_tran_fees}}"
                                                        name="renewal_tran_fees" class="form-control" id="visa1-id-11"
                                                        placeholder="...">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 col-xl-6 col-lg-12 col-md-6 ">
                                                <label for="visa1-id-13">Status</label>
                                                <select id="visa1-id-13"
                                                    class="form-control status-selector-select category"
                                                    name="renewal_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        {{$renewal_process['renewal_status']=='Approved' ? 'selected'
                                                        : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$renewal_process['renewal_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip" {{$renewal_process['renewal_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$renewal_process['renewal_status']=='Reject' ? 'selected' : ''
                                                        }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" value="{{$renewal_process->renewal_date}}"
                                                        name="renewal_date" class="form-control" id="visa1-id-12">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-visa8-9">Select File</label>
                                                <select id="new-visa8-9" class="form-control category"
                                                    name="renewal_file_name" value="">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo"
                                                    ...
                                                    <option value="Passport"
                                                        ...
                                                        Passport</option>
                                                    <option value="Visit Visa"
                                                        {{$renewal_process['renewal_file_name']=='Visit Visa'
                                                        ? 'selected' : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter"
                                                    ...
                                                    <option value="Work Permit"
                                                        {{$renewal_process['renewal_file_name']=='Work Permit'
                                                        ? 'selected' : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card"
                                                    ...
                                                    <option value="Residency Visa Application"
                                                        ...
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines"
                                                        {{$renewal_process['renewal_file_name']=='Visa Fines'
                                                        ? 'selected' : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines"
                                                        ...
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines"
                                                        {{$renewal_process['renewal_file_name']=='Other fines'
                                                        ? 'selected' : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines"
                                    ...
                                    <form
                                        ...
                                        <div class="row biometric-file-container">
                                            ...
                                            <div class="form-group mb-3 col-xl-6 col-lg-12 col-md-6 ">
                                                ...
                                                <select id="visa1-id-15"
                                                    class="form-control status-selector-select category"
                                                    name="emp_biometric_status">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        {{$renewal_process['emp_biometric_status']=='Approved'
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$renewal_process['emp_biometric_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip"
                                                        {{$renewal_process['emp_biometric_status']=='Skip' ? 'selected'
                                                        : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$renewal_process['emp_biometric_status']=='Reject'
                                                        ? 'selected' : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control biometric-select" id="visa1-id-17"
                                                        ...
                                                        <option value='required'
                                                            ...
                                                            : '' }}>Required</option>
                                                        <option value='not required'
                                                            {{$renewal_process['emp_biometric']=='not required'
                                                            ? 'selected' : '' }}>Not Required</option>
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="nav side-bar flex-row horizontal_tabs flex-lg-column nav-pills" id="v-pills-tab"
                            ...
                            <a class="nav-link active bordered_tab" id="v-pills-modify-visa-start-tab"
                                data-toggle="pill" href="#v-pills-modify-visa-start" role="tab"
                                aria-controls="v-pills-modify-visa-start" aria-selected="true">Start
                                Process</a>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tab-content" id="modification-visa-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    == 'Approved')
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-3-id" placeholder="..." disabled
                                                        value="process completed">
                                                    ...
                                                    @else
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-3-id" placeholder="..." disabled value="not started">
                                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-modify-visa-entry" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('dependent-modification-visa-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id'],'process_id'=>$modification_visa->id])}}"
                                        enctype="multipart/form-data" method="POST" class='py-2'>
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xl-6 col-lg-12 col-md-6 status-select-parent">
                                                ...
                                                <select id="new-visa-10" name="application_status"
                                                    class="form-control category status-selector-select status-select"
                                                    id="status-select1">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        {{$modification_visa['application_status']=='Approved'
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$modification_visa['application_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip"
                                                        {{$modification_visa['application_status']=='Skip' ? 'selected'
                                                        : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$modification_visa['application_status']=='Reject'
                                                        ? 'selected' : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-12 d-none status-select-comment">
                                                ...
                                                <textarea type="text" id='new-visa-11' name="application_reject_reason"
                                                    name="application_reject_reason"
                                                    value="{{$modification_visa->application_reject_reason}}"
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tab-content" id="modification-id-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-4-id" placeholder="..." disabled
                                                        value="process completed">
                            ...
                            <div class="tab-pane fade" id="v-pills-modify-id-entry" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('dependent-modification-emirates-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id'],'process_id'=>$modification_emirates->id])}}"
                                        enctype="multipart/form-data" method="POST" class='py-2'>
                                        @csrf
                                        <input type="hidden" value="application" name="application">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xl-6 col-lg-12 col-md-6 status-select-parent">
                                                ...
                                                <select id="new1-visa-10" name="application_status"
                                                    class="form-control category status-selector-select status-select"
                                                    id="status-select1">
                                                    <option value="" selected disabled>select</option>
                                                    <option value="Approved"
                                                        ...
                                                        ? 'selected' : '' }}>Approved</option>
                                                    <option value="UnderProcess"
                                                        {{$modification_emirates['application_status']=='UnderProcess'
                                                        ? 'selected' : '' }}>Under Process</option>
                                                    <option value="Skip"
                                                        {{$modification_emirates['application_status']=='Skip'
                                                        ? 'selected' : '' }}>Skip</option>
                                                    <option value="Reject"
                                                        {{$modification_emirates['application_status']=='Reject'
                                                        ? 'selected' : '' }}>Reject</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-12 d-none status-select-comment">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6 d-none status-select-approval">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="new1-visa-12"
                                                        ...
                                                        name="application_approval_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div
                                                class=" col-xl-6 col-lg-12 col-md-6 align-items-end status-select-file d-none">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tab-content" id="visa-cancel-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    == 'Approved' )
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-5-id" placeholder="..." disabled
                                                        value="process completed">
                                                    ...
                                                    @else
                                                    <input type="text" class="form-control process-status-input"
                                                        id="visa-5-id" placeholder="..." disabled value="not started">
                                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-residency-cancel" role="tabpanel"
                                ...
                                <div class='rounded py-3 light-box-shadow'>
                                    <form
                                        action="{{route('dependent-visa-cancellation-process',['user_id'=>$ids['user_id'],'dependent_id'=>$ids['dependent_id'],'process_id'=>$visa_cancellation->id])}}"
                                        enctype="multipart/form-data" method="POST" class='py-2'>
                                        @csrf
                                        <input type="hidden" value="residency" name="residency">
                                        <h6 class="mb-3"><span class="fa fa-solid fa-folder"></span> Residency
                                            Canceletion Application</h6>
                                        <div class="row align-items-end fine-select-container">
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="new-visa-id-14"
                                                        ...
                                                        name="residency_app_tranc_no" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="new-visa-id-15"
                                                        ...
                                                        name="residency_app_tranc_fee" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="new-visa-id-16">Status</label>
                                                    <select id="new-visa-id-16"
                                                        class="form-control status-selector-select category"
                                                        name="residency_app_status">
                                                        <option value="" selected disabled>select</option>
                                                        <option value="Approved"
                                                            {{$visa_cancellation['residency_app_status']=='Approved'
                                                            ? 'selected' : '' }}>Approved</option>
                                                        <option value="UnderProcess"
                                                            {{$visa_cancellation['residency_app_status']=='UnderProcess'
                                                            ? 'selected' : '' }}>Under Process</option>
                                                        <option value="Skip"
                                                            {{$visa_cancellation['residency_app_status']=='Skip'
                                                            ? 'selected' : '' }}>Skip</option>
                                                        <option value="Reject"
                                                            {{$visa_cancellation['residency_app_status']=='Reject'
                                                            ? 'selected' : '' }}>Reject</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="new-visa-id-17"
                                                        ...
                                                        name="residency_app_date" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12 form-group col-md-6 gap-1 align-items-end mb-3">
                                                <label for="new-new-visa4-8">Select File</label>
                                                <select id="new-new-visa4-8" class="form-control category"
                                                    name="residency_app_file_name" value="">
                                                    <option value="" selected disabled>Select Document</option>
                                                    <option value="Personal Photo"
                                                        {{$visa_cancellation['residency_app_file_name']=='Personal Photo'
                                                        ? 'selected' : '' }}>Personal Photo
                                                    </option>
                                                    <option value="Passport"
                                                        {{$visa_cancellation['residency_app_file_name']=='Passport'
                                                        ? 'selected' : '' }}>
                                                        Passport</option>
                                                    <option value="Visit Visa"
                                                        {{$visa_cancellation['residency_app_file_name']=='Visit Visa'
                                                        ? 'selected' : '' }}>
                                                        Visit Visa</option>
                                                    <option value="Offer Letter"
                                                        {{$visa_cancellation['residency_app_file_name']=='Offer Letter'
                                                        ? 'selected' : '' }}>Offer Letter</option>
                                                    <option value="MOL Job Offer"
                                                        {{$visa_cancellation['residency_app_file_name']=='MOL Job Offer'
                                                        ? 'selected' : '' }}>MOL Job Offer</option>
                                                    <option value="Signed MOL Job Offer"
                                                        {{$visa_cancellation['residency_app_file_name']=='Signed MOL Job Offer'
                                                        ? 'selected' : '' }}>Signed MOL Job
                                                        Offer</option>
                                                    <option value="MOL MB Contract"
                                                        {{$visa_cancellation['residency_app_file_name']=='MOL MB Contract'
                                                        ? 'selected' : '' }}>MOL MB Contract
                                                    </option>
                                                    <option value="Signed MOL MB Offer"
                                                        {{$visa_cancellation['residency_app_file_name']=='Signed MOL MB Offer'
                                                        ? 'selected' : '' }}>Signed MOL MB
                                                        Offer</option>
                                                    <option value="Preapproval Work Permit"
                                                        {{$visa_cancellation['residency_app_file_name']=='Preapproval Work Permit'
                                                        ? 'selected' : '' }}>Preapproval
                                                        Work Permit</option>
                                                    <option value="Dubai Insurance"
                                                        {{$visa_cancellation['residency_app_file_name']=='Dubai Insurance'
                                                        ? 'selected' : '' }}>Dubai Insurance
                                                    </option>
                                                    <option value="Entry Permit Visa"
                                                        {{$visa_cancellation['residency_app_file_name']=='Entry Permit Visa'
                                                        ? 'selected' : '' }}>Entry Permit Visa
                                                    </option>
                                                    <option value="Stamped Entry Visa"
                                                        {{$visa_cancellation['residency_app_file_name']=='Stamped Entry Visa'
                                                        ? 'selected' : '' }}>Stamped Entry
                                                        Visa</option>
                                                    <option value="Change of Visa Status"
                                                        {{$visa_cancellation['residency_app_file_name']=='Change of Visa Status'
                                                        ? 'selected' : '' }}>Change of Visa
                                                        Status</option>
                                                    <option value="Medical Fitness Receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Medical Fitness Receipt'
                                                        ? 'selected' : '' }}>Medical
                                                        Fitness Receipt</option>
                                                    <option value="Tawjeeh Receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Tawjeeh Receipt'
                                                        ? 'selected' : '' }}>Tawjeeh Receipt
                                                    </option>
                                                    <option value="Emirates Id Application form"
                                                        {{$visa_cancellation['residency_app_file_name']=='Emirates Id Application form'
                                                        ? 'selected' : '' }}>
                                                        Emirates Id Application form</option>
                                                    <option value="Stamped EID Application form"
                                                        {{$visa_cancellation['residency_app_file_name']=='Stamped EID Application form'
                                                        ? 'selected' : '' }}>Stamped
                                                        EID Application form</option>
                                                    <option value="Residence Visa"
                                                        {{$visa_cancellation['residency_app_file_name']=='Residence Visa'
                                                        ? 'selected' : '' }}>Residence Visa
                                                    </option>
                                                    <option value="Work Permit"
                                                        {{$visa_cancellation['residency_app_file_name']=='Work Permit'
                                                        ? 'selected' : '' }}>
                                                        Work Permit</option>
                                                    <option value="Health Insurance Card"
                                                        {{$visa_cancellation['residency_app_file_name']=='Health Insurance Card'
                                                        ? 'selected' : '' }}>Health
                                                        Insurance Card</option>
                                                    <option value="National Identity Card"
                                                        {{$visa_cancellation['residency_app_file_name']=='National Identity Card'
                                                        ? 'selected' : '' }}>National
                                                        Identity Card</option>
                                                    <option value="Emirates Identity Card"
                                                        {{$visa_cancellation['residency_app_file_name']=='Emirates Identity Card'
                                                        ? 'selected' : '' }}>Emirates
                                                        Identity Card</option>
                                                    <option value="Vehicle Registration Card"
                                                        {{$visa_cancellation['residency_app_file_name']=='Vehicle Registration Card'
                                                        ? 'selected' : '' }}>Vehicle
                                                        Registration Card</option>
                                                    <option value="Driving License"
                                                        {{$visa_cancellation['residency_app_file_name']=='Driving License'
                                                        ? 'selected' : '' }}>Driving License
                                                    </option>
                                                    <option value="Birth Certificate"
                                                        {{$visa_cancellation['residency_app_file_name']=='Birth Certificate'
                                                        ? 'selected' : '' }}>Birth Certificate
                                                    </option>
                                                    <option value="Marriage Certificate"
                                                        {{$visa_cancellation['residency_app_file_name']=='Marriage Certificate'
                                                        ? 'selected' : '' }}>Marriage
                                                        Certificate</option>
                                                    <option value="School Certificate"
                                                        {{$visa_cancellation['residency_app_file_name']=='School Certificate'
                                                        ? 'selected' : '' }}>School
                                                        Certificate</option>
                                                    <option value="Diploma"
                                                        {{$visa_cancellation['residency_app_file_name']=='Diploma'
                                                        ? 'selected' : '' }}>Diploma
                                                    </option>
                                                    <option value="University Degree"
                                                        {{$visa_cancellation['residency_app_file_name']=='University Degree'
                                                        ? 'selected' : '' }}>University Degree
                                                    </option>
                                                    <option value="Salary Certificate"
                                                        {{$visa_cancellation['residency_app_file_name']=='Salary Certificate'
                                                        ? 'selected' : '' }}>Salary
                                                        Certificate</option>
                                                    <option value="Tenancy Contract"
                                                        {{$visa_cancellation['residency_app_file_name']=='Tenancy Contract'
                                                        ? 'selected' : '' }}>Tenancy Contract
                                                    </option>
                                                    <option value="MOL Cancellation form"
                                                        {{$visa_cancellation['residency_app_file_name']=='MOL Cancellation form'
                                                        ? 'selected' : '' }}>MOL
                                                        Cancellation form</option>
                                                    <option value="Signed MOL Cancellation Form"
                                                        {{$visa_cancellation['residency_app_file_name']=='Signed MOL Cancellation Form'
                                                        ? 'selected' : '' }}>Signed
                                                        MOL Cancellation Form</option>
                                                    <option value="Work Permit Cancellation Approval"
                                                        {{$visa_cancellation['residency_app_file_name']=='Work Permit Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Work Permit Cancellation Approval</option>
                                                    <option value="Residency Cancellation Approval"
                                                        {{$visa_cancellation['residency_app_file_name']=='Residency Cancellation Approval'
                                                        ? 'selected' : '' }}>
                                                        Residency Cancellation Approval</option>
                                                    <option value="Modify MOL Contract"
                                                        {{$visa_cancellation['residency_app_file_name']=='Modify MOL Contract'
                                                        ? 'selected' : '' }}>Modify MOL
                                                        Contract</option>
                                                    <option value="Work Permit Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='Work Permit Application'
                                                        ? 'selected' : '' }}>Work Permit
                                                        Application</option>
                                                    <option value="Work Permit Renewal Application"
                                                    ...
                                                    <option value="Preapproval of work permit receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Preapproval of work permit receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval of work permit</option>
                                                    <option value="Dubai Insurance receipts"
                                                        {{$visa_cancellation['residency_app_file_name']=='Dubai Insurance receipts'
                                                        ? 'selected' : '' }}>
                                                        Dubai Insurance</option>
                                                    <option value="Preapproval work permit fees receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Preapproval work permit fees receipt'
                                                        ? 'selected' : '' }}>
                                                        Preapproval work permit fees</option>
                                                    <option value="Work permit Renewal Fees Receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Work permit Renewal Fees Receipt'
                                                        ? 'selected' : '' }}>
                                                        Work permit Renewal Fees</option>
                                                    <option value="Entry Visa Application Receipt"
                                                        {{$visa_cancellation['residency_app_file_name']=='Entry Visa Application Receipt'
                                                        ? 'selected' : '' }}>
                                                        Entry Visa Application</option>
                                                    <option value="Change of Visa Status Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='Change of Visa Status Application'
                                                        ? 'selected' : '' }}>
                                                        Change of Visa Status Application</option>
                                                    <option value="Medical"
                                                        {{$visa_cancellation['residency_app_file_name']=='Medical'
                                                        ? 'selected' : '' }}>Medical
                                                    </option>
                                                    <option value="Tawjeeh"
                                                        {{$visa_cancellation['residency_app_file_name']=='Tawjeeh'
                                                        ? 'selected' : '' }}>Tawjeeh
                                                    </option>
                                                    <option value="Heath Insurance"
                                                        {{$visa_cancellation['residency_app_file_name']=='Heath Insurance'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance</option>
                                                    <option value="Emirates ID Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='Emirates ID Application'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Application</option>
                                                    <option value="Residency Visa Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='Residency Visa Application'
                                                        ? 'selected' : '' }}>
                                                        Residency Visa Application</option>
                                                    <option value="Visa Fines"
                                                        {{$visa_cancellation['residency_app_file_name']=='Visa Fines'
                                                        ? 'selected' : '' }}>Visa
                                                        Fines</option>
                                                    <option value="Emirates ID Fines"
                                                        {{$visa_cancellation['residency_app_file_name']=='Emirates ID Fines'
                                                        ? 'selected' : '' }}>
                                                        Emirates ID Fines</option>
                                                    <option value="Other fines"
                                                        {{$visa_cancellation['residency_app_file_name']=='Other fines'
                                                        ? 'selected' : '' }}>
                                                        Other fines</option>
                                                    <option value="Health Insurance Fines"
                                                        {{$visa_cancellation['residency_app_file_name']=='Health Insurance Fines'
                                                        ? 'selected' : '' }}>
                                                        Health Insurance Fines</option>
                                                    <option value="Immigration Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='Immigration Application'
                                                        ? 'selected' : '' }}>
                                                        Immigration Application</option>
                                                    <option value="MOHRE Application"
                                                        {{$visa_cancellation['residency_app_file_name']=='MOHRE Application'
                                                        ? 'selected' : '' }}>
                                                        MOHRE Application</option>
                                                    <option value="Other"
                                                        {{$visa_cancellation['residency_app_file_name']=='Other'
                                                        ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="upload-file form-group mb-3">
                                                        ...
                                                        <div class="input-group mb-xl-0 mb-lg-3 mb-md-0">
                                                            <input type="file" class="form-control"
                                                                id='new-visa3-41-id1' name="residency_app_file"
...
<script>
    $(function () {
        ...
        $('.process-status-input').each(function () {
            count++;
            let flag=false;
            let helper=$(this).closest('.tab-pane');
            if ($(this).val() == 'process started') {
                $(this).closest('.tab-content').find('.status-selector-select').each(function () {
                    if($(this).val()!=='Approved' && $(this).val()!=='Skip'){
                        ...
                        $('.process-starter').each(function(){
                            $(this).addClass('active show');
                        });
                        helper.removeClass('active show');
                        let c=$(this).closest('.tab-pane').attr('aria-labelledby');
                        $('#'+c).click();
                        $('.tab-'+count).click();
                        $(this).parents('.tab-pane').addClass('show active');
