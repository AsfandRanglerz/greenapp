...
<style>
    ...
    <div class="mb-5 admin-main-content-inner">
        ...
        <div class="text-right">
            <a href="{{ route('user.dependent-document-create',$id) }}" class="mb-3 btn btn-success"><span class="fa fa-plus mr-2"></span>Add
                Document</a>
        </div>
                        ...
                        @foreach ($documents as $document)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @endphp
                                    <a href="{{ route('user.dependent-document-download', $ext[1]) }}"><span
                                            class="fa fa-download text-success"></span></a>
                                    @if (Auth::guard('web')->user()->emp_type == 'self')
                                        <a href="{{ route('user.dependent-document-edit', $document->id) }}" class="mx-2"><span
                                                class="fa fa-edit text-info"></span></a>
                                        <form class="d-inline" method="post"
                                            action="{{ route('user.dependent-document-destroy', $document->id) }}">
                                            @csrf
