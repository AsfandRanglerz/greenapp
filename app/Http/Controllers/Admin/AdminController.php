...
class AdminController extends Controller
{
    ...
    public function getdashboard()
    {
        ...
        $user = User::where('emp_type', 'company')->select('id')->get();
        $userdocument = UserDocument::with('user')
            ->whereHas('user', function ($query) {
                $query->where('emp_type', 'company');
            })
            ->select('id')
            ->get();
        $individual = User::where('emp_type', 'self')->select('id')->get();
        $individualDocument = UserDocument::with('user')
            ->whereHas('user', function ($query) {
                $query->where('emp_type', 'self');
            })
            ->select('id')
            ->get();
        return view('admin.index', compact('company', 'companydocument', 'user', 'userdocument','individual','individualDocument'));
    }
