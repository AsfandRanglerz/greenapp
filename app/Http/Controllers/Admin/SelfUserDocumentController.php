...
class SelfUserDocumentController extends Controller
{
     /**
    ...
    {
        $user = User::find($id);
        return view('admin.self-user.document.add', compact('user'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->route('self-document.index', $id)->with('success', 'Added Successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.self-user.document.edit', compact(['document']));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $document->update();
        return redirect()->route('self-document.index', $document->user_id)->with('success', 'Updated Successfully');
    }
