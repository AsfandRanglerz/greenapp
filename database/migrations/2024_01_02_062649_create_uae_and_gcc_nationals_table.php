...
class CreateUaeAndGccNationalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('uae_and_gcc_nationals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('uae_and_gcc_nationals');
    }
}
