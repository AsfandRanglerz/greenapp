...
class CreatePartTimeAndTemporariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('part_time_and_temporaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('part_time_and_temporaries');
    }
}
