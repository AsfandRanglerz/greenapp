        ...
        <div class="p-xl-4 p-3 admin-main-content">
            <div class="mb-5 admin-main-content-inner">
                ...
                <div class="text-right">
                    <a href="add-employee-details.php" class="mb-3 btn btn-success"><span class="fa fa-plus mr-2"></span>Add Employee</a>
                </div>
                            ...
                            <tbody class="employees-body">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="employee-details.php"><span class="fa fa-eye text-success"></span></a>
